...
def is_quran_page_link(link):
    return re.match(r'^https://equranlibrary\.com/quran/\d+$', link) or re.match(r'^https://equranlibrary\.com/hadith/ibnemajah/\d+/\d+$', link) 
...
if __name__ == "__main__":
    driver = webdriver.Chrome()
    start_url = 'https://equranlibrary.com/hadithlist/ibnemajah/1621'
